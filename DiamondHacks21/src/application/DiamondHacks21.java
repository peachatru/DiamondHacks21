...
public class DiamondHacks21 {
    ...
    */
    ...
    public static String getPastEvent() {
        ...
        pastEvents.add(fact10);// Mexico
        pastEvents.add(fact11);// Hawaii and other Pacific Islands
        pastEvents.add(fact12);// Hawaii and other Pacific Islands
        pastEvents.add(fact13);// the Phillippines
        pastEvents.add(fact14);// the Phillippines
    ...
    public static String getMoreResources() {
        ArrayList<String> websitesWithInformation = new ArrayList<String>();
        ...
        // include random generator here for random past event
        Random random = new Random();
        int index = random.nextInt(websitesWithInformation.size() - 1); // Random int from pastEvents array list.

        String websiteForUser = websitesWithInformation.get(index); // choose a random link for user
        return websiteForUser;
        }

    public static String getInvolved() {
        ArrayList<String> beInvolvedActivities = new ArrayList<String>();
    ...
    // "how to get involved" : petitions, local businesses, book recommendation
    public static void main(String[] args) {
        System.out.println("\t\tWelcome to 'Stay Informed, Stay Involved'!\t\t");
        System.out.println("In light of recent events and rising hate crimes against POCs, our team\n" +
                "wanted to create a program that would serve as a resource to stay informed\nand stay engaged to combat " +
        ...
        while (runningProgram == true) {
            ...
            switch (Character.toLowerCase(optionChoice)) {
                case 'p':
